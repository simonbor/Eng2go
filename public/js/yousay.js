...
$(document).ready(function () {    
    ...
    $('#goBtn').on('click', function () {
        ...
        ysViewModel.you_say_num(youSay);
        ysViewModel.you_say_item_num(STARTED_ITEM_NUM);
...
function speak(mp3){
    new Audio('http://english2go.com/YouSay/Sounds/' + mp3 + '.mp3').play();
}
